...
import { useGetBestSellingProductsQuery } from "../../../../features/product/productSlice";
    ...
    <div className="container mx-auto lg:mb-10 mb-5">
      ...
      <div className="flex lg:justify-between md:justify-between justify-center items-center mt-12 border-b-2 border-b-[#2563eb] pb-3 mb-5">
        ...
        <HeadingTitle
          title="Best"
          subTitle="Selling"
          details="View Best Selling products in last month"
        />
        {/* Slider Arrow Item */}
      ...
      {bestSellingProducts?.length > 0 ? (
        <Slider ref={slider} {...sliderSettings}>
          {bestSellingProducts?.map((sellar) => (
            <div key={sellar?._id} className="mt-7">
              <ProductsCard item={sellar} />
            </div>
          ))}
        </Slider>
      ) : (
